...
function setup() 
{
  ...
  fruit = Bodies.circle(canW/2,300,50);
...
function draw() 
{
  ...
  corda03.show();
  if(fruit!= null){
  image(fruta,fruit.position.x,fruit.position.y,200,200);
  }
